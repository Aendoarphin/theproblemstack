...
function Header() {
  ...
  return (
    <header className="w-full p-4 inline-flex items-center fixed top-0 z-2">
      <div id="brand-container" className="cursor-pointer">
        <Link href={"/"}>
          <Image
      ...
      >
        ...
        <aside id="side-bar">
          <div
            className={`absolute top-0 right-0 bg-foreground text-background p-4 shadow-md flex flex-col gap-4 transition-transform ${
