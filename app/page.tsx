      ...
      <main>
        ...
        <section className="mt-20 h-1/2 px-6 max-w-2xl md:w-3xl lg:max-w-6xl mx-auto flex flex-col">
          ...
          <div className="sm:inline-flex gap-4 items-center">
            <p>
              Stop building to ship and start building to solve. Innovation
              lives in the messy, unsolved problems, not in the tenth iteration
              of a weather app. Find a problem that matters and own the
              solution!
            </p>
            <br />
            <button className="bg-black text-nowrap from-primary h-max from-50% bg-linear-30 to-white to-110% text-white rounded-lg p-2 w-max shadow-lg md:mx-auto">
              Explore Now
            </button>
          </div>
        </section>
          ...
          {steps.map((step) => (
            <div key={step.id} className="flex flex-col items-start text-left">
              ...
              <div className="space-y-3">
                ...
                <div className="w-8 h-0.5 bg-primary"></div> {/* divider */}
